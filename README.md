...
Total stars:   --        Commits (last year):  --
──────────────────────────────────────────────────
Updated: never (stats update automatically)
```
<!-- STATS:END -->

## About me

**Results-driven DevOps Engineer** with 8 years of hands-on experience in cloud platforms, containerization, infrastructure automation, CI/CD, and monitoring. I have a proven track record of leading a small DevOps team - delegating tasks, mentoring engineers, and keeping operations running smoothly. I design scalable, secure, and cost-efficient infrastructure, with automation and architectural reliability as top priorities, and I'm comfortable using GitHub and other version control platforms to keep collaboration and deployments moving. Over the past couple of years I've also brought AI tooling - including Claude, Claude Code, and the Model Context Protocol - into my day-to-day work to speed up development, automate repetitive operational tasks, and ship more reliably. I'm committed to continuous learning and to building a healthy DevOps culture on any team I'm part of.
